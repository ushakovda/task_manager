...
from .views import TaskCreateView, TaskDetailAjaxView, TaskUpdateView, TaskDeleteView, UpdateActualEffortView, UpdateTaskStatusView
...
urlpatterns = [
    ...
    path('task/<int:pk>/details/', TaskDetailAjaxView.as_view(), name='task_details'),
]
